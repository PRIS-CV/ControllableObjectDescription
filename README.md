# Evaluating and Refining Attributes in Object Descriptions Generated by MLLMs
...
Code for our NeurIPS 2024
paper "[Evaluating and Refining Attributes in Object Descriptions Generated by MLLMs](https://openreview.net/attachment?id=uOloLqskxM&name=pdf)".

<p align="center">
    <img src="figs/refine_method.jpg"" width="80%"> <br>
  <p align="center" style="font-size:1.2vw;">The diagram of our description refinement pipeline, attribute polisher</p>
</p>
...
2. Install Package
```Shell
conda create -n polisher python=3.10 -y
conda activate polisher
...
Here, we used images from COCO2017 dataset for experiments. OVD processing and llava generation caption were performed in advance, and the results were saved in a JSON file.
...
Our demo will be updated shortly.

## Acknowledgement

- [OVAD](https://github.com/OVAD-Benchmark/ovad-benchmark-code): Some of our code borrows from OVAD, and you can find more information here.
